...
<header class="h-20 bg-hostinger-card/60 backdrop-blur-md border-b border-hostinger-border px-6 flex items-center justify-between sticky top-0 z-30">
    <div class="flex items-center space-x-4">
        ...
        <button class="md:hidden p-2 text-slate-500 hover:text-slate-900 rounded-lg border border-hostinger-border">
    ...
    <div class="flex items-center space-x-4">
        <div class="flex items-center space-x-2 px-3 py-1.5 rounded-full bg-emerald-100 border border-emerald-500/20 text-emerald-700 text-xs font-semibold">
