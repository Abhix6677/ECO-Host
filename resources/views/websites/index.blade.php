...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-gray-400 mt-0.5">Manage, deploy, and monitor terminal logs for your static web projects</p>
        </div>
    ...
    @else
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
            @foreach ($websites as $site)
                <div class="bg-hostinger-card border border-hostinger-border rounded-2xl p-6 flex flex-col justify-between hover:border-indigo-500/50 hover:shadow-xl hover:shadow-indigo-500/5 transition-all duration-200 group cursor-pointer relative"
                    ...
                    <div>
                        ...
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex items-center space-x-3 min-w-0">
                                <div class="w-11 h-11 rounded-xl bg-indigo-500/10 border border-indigo-500/20 flex items-center justify-center text-indigo-400 shrink-0 group-hover:bg-indigo-600 group-hover:text-white transition duration-200">
                                    <i data-lucide="globe" class="w-6 h-6"></i>
                                </div>
                                <div class="min-w-0">
                                    <a href="{{ route('websites.show', $site) }}" 
                                       @click.stop
                                       class="font-bold text-white text-base truncate hover:text-indigo-400 transition block">
                                        {{ $site->name }}
                                    </a>
                    ...
                    <div class="space-y-3 pt-4 border-t border-hostinger-border">
                        <div class="flex items-center justify-between text-xs text-indigo-400 group-hover:text-indigo-300 font-bold transition">
